function GETST_FRCR() {
  for (
    ...
    if (t[n].src.indexOf("jwplayer.js") !== -1) {
      return t[n].src;
    }
  }
}
var SCR_MAIN_URL = GETST_FRCR();
var SCR_MAIN_URL_ORIGIN = SCR_MAIN_URL.replace("jwplayer.js", "");
(() => {
  var e,
    t,
    n = {
      ...
      2445: (e, t, n) => {
        ...
        const g = (e) =>
          ...
          v = (e) => {
            const n = {
              bidding: SCR_MAIN_URL_ORIGIN + "bidding.js",
              jwpsrv: SCR_MAIN_URL_ORIGIN + "jwpsrv.js",
              dai: SCR_MAIN_URL_ORIGIN + "dai.js",
              vast: SCR_MAIN_URL_ORIGIN + "vast.js",
              googima: SCR_MAIN_URL_ORIGIN + "googima.js",
              freewheel: SCR_MAIN_URL_ORIGIN + "freewheel.js",
              gapro: SCR_MAIN_URL_ORIGIN + "gapro.js",
              interactive: SCR_MAIN_URL_ORIGIN + "interactive.js",
            }[e];
            return n;
          },
          b = (e, t, n) => {
